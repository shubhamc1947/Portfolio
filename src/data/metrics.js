const metrics = [
  { value: '600K', unit: '+', label: 'bookings / month' },
  { value: '<200', unit: 'ms', label: 'p95 response time' },
  { value: '99.9', unit: '%', label: 'uptime, rolling 90d' },
  { value: '966K', unit: '+', label: 'impressions, 5 months' },
